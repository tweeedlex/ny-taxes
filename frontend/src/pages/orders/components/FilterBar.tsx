...
export function FilterBar({
  ...
  return (
    <div className="px-4 lg:px-8 pb-4 space-y-3">
      ...
      <AnimatePresence>{showFilters && <ExpandedFilters />}</AnimatePresence>
    </div>
  );
}
...
function ExpandedFilters() {
  return (
    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 rounded-xl border border-border bg-background">
